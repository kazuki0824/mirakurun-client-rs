...
pub async fn get_logo_image(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<GetLogoImageError>> {
...
pub async fn get_service(configuration: &configuration::Configuration, id: i32) -> Result<crate::models::Service, Error<GetServiceError>> {
    let local_var_configuration = configuration;
...
pub async fn get_service_stream(configuration: &configuration::Configuration, id: i32, x_mirakurun_priority: Option<i32>, decode: Option<i32>) -> Result<(), Error<GetServiceStreamError>> {
    let local_var_configuration = configuration;
...
pub async fn get_services(configuration: &configuration::Configuration, service_id: Option<i32>, network_id: Option<i32>, name: Option<&str>, _type: Option<i32>, channel_type: Option<&str>, channel_channel: Option<&str>) -> Result<Vec<crate::models::Service>, Error<GetServicesError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = channel_type {
        local_var_req_builder = local_var_req_builder.query(&[("channel.type", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = channel_channel {
