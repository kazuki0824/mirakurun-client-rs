...
pub async fn get_events_stream(configuration: &configuration::Configuration, resource: Option<&str>, _type: Option<&str>) -> Result<Vec<crate::models::Event>, Error<GetEventsStreamError>> {
    let local_var_configuration = configuration;
...
pub async fn get_program_stream(configuration: &configuration::Configuration, id: i32, x_mirakurun_priority: Option<i32>, decode: Option<i32>) -> Result<(), Error<GetProgramStreamError>> {
    let local_var_configuration = configuration;
